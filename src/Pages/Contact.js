...
<form action="https://getform.io/f/7f90499c-27d8-416c-a92a-6d05934f3b9d" className='border rounded-lg p-10' method="POST">
 ...
 <div className='flex flex-col'>
    <label>Name</label>
    <input type="text" name="name"  className='w-[400px] rounded-md h-9 border border-gray-600 ' />
 </div>
 <div className='flex flex-col'>
    <label>Email</label>
    <input type="email" name="email"  className='w-[400px] rounded-md h-9 border border-gray-600 '/>
 </div>
 <div className='flex flex-col'>

    <label>Message</label>
    <input type="text" name="message" className='w-[400px] rounded-md h-[150px] border border-gray-600 '  aria-multiline={true}/>
 </div>
 <div className='flex justify-center'>

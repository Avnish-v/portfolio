...
<form action="https://getform.io/f/7f90499c-27d8-416c-a92a-6d05934f3b9d" className=' w-[90%] md:w-[500px] border rounded-lg p-10 text-black' method="POST">
 ...
 <div className='flex flex-col '>
    <label>Name</label>
    <input type="text" name="name" placeholder='Name' className='md:w-[400px] px-2 py-1 rounded-md h-9 border border-gray-600 ' />
 </div>
 <div className='flex flex-col'>
    <label>Email</label>
    <input type="email" name="email" placeholder='email' className='md:w-[400px] px-2 py-1 rounded-md h-9 border border-gray-600 '/>
 </div>
 <div className='flex flex-col'>

    <label>Message</label>
    <textarea type="text" name="message"  placeholder='Additional information' className='md:w-[400px] px-2 py-1 resize-none rounded-md h-[150px] border border-gray-600 '  />
 </div>
 <div className='flex justify-center'>
